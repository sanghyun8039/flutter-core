...
class _$GetUserEventImpl implements _GetUserEvent {
  const _$GetUserEventImpl(this.id);
...
abstract class _GetUserEvent implements UserEvent {
  const factory _GetUserEvent(final String id) = _$GetUserEventImpl;
...
abstract class _Error implements UserState {
  const factory _Error(final ServerFailure failure) = _$ErrorImpl;
